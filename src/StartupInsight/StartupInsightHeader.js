...
function Header() {
  return (
    <div className="startupinsightheader">
      <div className="startupinsightheader__left">
        <Link to="/">
          <div className="startupinsightheaderimg__container">
            <img
      ...
      <div className="startupinsightheader__right">
        <Link to="/" style={{ textDecoration: "none" }}>
          <div className="startupinsightheader__right__home">
            <h4 style={{ color: "white" }}>Home</h4>
          </div>
        </Link>
        {/* <div className="startupinsightheader__right__initiatives">
          <h4 style={{ color: "white" }}>Initiatives</h4>
        </div> */}
        <div className="startupinsightheader__right__initiative__dropdown">
          <span
            className="startupinsightheader__right__initiative__dropbutton"
            style={{ color: "white" }}
          >
            Initiatives
          </span>
          <div className="startupinsightheader__right__initiative__dropdowncontent">
            <Link
              to="/entrepreneurshipkickstart"
              style={{ textDecoration: "none" }}
            >
              <div className="startupinsightheader__dropdownboxes">
        ...
        <Link to="/startupinsight" style={{ textDecoration: "none" }}>
          <div className="startupinsightheader__right__startupinsight">
            <h4 style={{ color: "yellow" }}>Startup Insight</h4>
          </div>
        </Link>
        <Link to="/team" style={{ textDecoration: "none" }}>
          <div className="startupinsightheader__right__team">
            <h4 style={{ color: "white" }}>Team</h4>
          </div>
        </Link>
        <hr />
        <Link to="/contactus" style={{ textDecoration: "none" }}>
          <div className="startupinsightheader__right__contact">
